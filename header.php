...
$colour_class = "";
if (isset($args["header_colour_class"])) {
  $colour_class = $args["header_colour_class"];
} elseif ($_COOKIE["ExampleColour"]) {
  $colour_class = $_COOKIE["ExampleColour"];
}
...
?>
<!DOCTYPE html>
<html id="hale-showcase-html" <?php language_attributes(); ?> class="hale-page <?php echo $colour_class; ?>">
<head>
